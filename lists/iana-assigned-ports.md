...
| 271 | TCP | pt-tls | IETF Network Endpoint Assessment (NEA) Posture Transport Protocol |
...
| 512 | TCP | exec | remote process execution; authentication performed using password |
| 512 | UDP | biff | used by mail system to notify users of new mail received; current |
| 512 | UDP | comsat |  |
| 513 | TCP | login | remote login a la telnet; automatic authentication performed base |
| 513 | UDP | who | maintains data bases showing who's logged in to machines on a loc |
| 514 | TCP | shell | cmd like exec, but automatic authentication is performed as for l |
| 514 | UDP | syslog |  |
| 515 | TCP | printer | spooler |
| 515 | UDP | printer | spooler |
| 516 | TCP | videotex | videotex |
| 516 | UDP | videotex | videotex |
| 517 | TCP | talk | like tenex link, but across machine - unfortunately, doesn't use  |
| 517 | UDP | talk | like tenex link, but across machine - unfortunately, doesn't use  |
| 518 | TCP | ntalk |  |
| 518 | UDP | ntalk |  |
...
| 689 | TCP | nmap | NMAP |
| 689 | UDP | nmap | NMAP |
| 690 | TCP | vatp | Velazquez Application Transfer Protocol |
| 690 | UDP | vatp | Velazquez Application Transfer Protocol |
...
| 773 | UDP | notify |  |
| 774 | TCP | rpasswd |  |
| 774 | UDP | acmaint-dbd | IANA assigned this well-formed service name as a replacement for  |
| 774 | UDP | acmaint_dbd |  |
| 775 | TCP | entomb |  |
| 775 | UDP | acmaint-transd | IANA assigned this well-formed service name as a replacement for  |
...
| 780 | TCP | wpgs |  |
| 780 | UDP | wpgs |  |
| 800 | TCP | mdbs-daemon | IANA assigned this well-formed service name as a replacement for  |
| 800 | TCP | mdbs_daemon |  |
| 800 | UDP | mdbs-daemon | IANA assigned this well-formed service name as a replacement for  |
| 800 | UDP | mdbs_daemon |  |
| 801 | TCP | device |  |
| 801 | UDP | device |  |
...
| 862 | TCP | twamp-control | Two-way Active Measurement Protocol (TWAMP) Control |
| 862 | UDP | twamp-control | Two-way Active Measurement Protocol (TWAMP) Control |
| 873 | TCP | rsync | rsync |
| 873 | UDP | rsync | rsync |
...
| 1883 | TCP | ibm-mqisdp | IBM MQSeries SCADA |
| 1883 | UDP | ibm-mqisdp | IBM MQSeries SCADA |
...
| 2009 | UDP | whosockami |  |
| 2010 | TCP | search |  |
| 2010 | UDP | pipe-server | IANA assigned this well-formed service name as a replacement for  |
...
| 2804 | TCP | dvr-esm | March Networks Digital Video Recorders and Enterprise Service Man |
| 2804 | UDP | dvr-esm | March Networks Digital Video Recorders and Enterprise Service Man |
...
| 3071 | TCP | csd-mgmt-port | ContinuStor Manager Port |
| 3071 | UDP | csd-mgmt-port | ContinuStor Manager Port |
...
| 3095 | TCP | panasas | Panasas rendevous port |
| 3095 | UDP | panasas | Panasas rendevous port |
...
| 3121 | TCP | pcmk-remote | The pacemaker remote (pcmk-remote) service extends high availabil |
...
| 3445 | TCP | monp | Media Object Network |
| 3445 | UDP | monp | Media Object Network |
...
| 3453 | TCP | pscupd | PSC Update Port |
| 3453 | UDP | pscupd | PSC Update Port |
...
| 3567 | TCP | enc-eps | EMIT protocol stack |
| 3567 | UDP | enc-eps | EMIT protocol stack |
| 3568 | TCP | enc-tunnel-sec | EMIT secure tunnel |
| 3568 | UDP | enc-tunnel-sec | EMIT secure tunnel |
...
| 3612 | TCP | hp-dataprotect | HP Data Protector |
| 3612 | UDP | hp-dataprotect | HP Data Protector |
...
| 3697 | UDP | nw-license | NavisWorks Licnese System |
...
| 3726 | UDP | array-manager | Xyartex Array Manager |
...
| 3750 | UDP | cbos-ip-port | CBOS/IP ncapsalatoin port |
...
| 3841 | TCP | zfirm-shiprush3 | Z-Firm ShipRush v3 |
| 3841 | UDP | zfirm-shiprush3 | Z-Firm ShipRush v3 |
...
| 3849 | UDP | spw-dnspreload | SPACEWAY DNS Prelaod |
...
| 3917 | UDP | aftmux | AFT multiples port |
...
| 3947 | TCP | ccp | Connect and Control Protocol for Consumer, Commercial, and Indust |
| 3947 | UDP | ccp | Connect and Control Protocol for Consumer, Commercial, and Indust |
...
| 3974 | TCP | citysearch | Remote Applicant Tracking Service |
| 3974 | UDP | citysearch | Remote Applicant Tracking Service |
| 3975 | TCP | airshot | Air Shot |
| 3975 | UDP | airshot | Air Shot |
| 3976 | TCP | opswagent | Opsware Agent |
| 3976 | UDP | opswagent | Opsware Agent |
...
| 3980 | TCP | acms | Aircraft Cabin Management System |
| 3980 | UDP | acms | Aircraft Cabin Management System |
...
| 4073 | TCP | iRAPP | iRAPP Server Protocol |
| 4073 | UDP | iRAPP | iRAPP Server Protocol |
...
| 4307 | TCP | visicron-vs | Visicron Videoconference Service |
| 4307 | UDP | visicron-vs | Visicron Videoconference Service |
...
| 4324 | TCP | balour | Balour Game Server |
| 4324 | UDP | balour | Balour Game Server |
| 4325 | TCP | geognosisman | Cadcorp GeognoSIS Manager Service |
| 4325 | UDP | geognosisman | Cadcorp GeognoSIS Manager Service |
| 4326 | TCP | geognosis | Cadcorp GeognoSIS Service |
| 4326 | UDP | geognosis | Cadcorp GeognoSIS Service |
...
| 4331 | TCP | ktickets-rest | ktickets REST API for event management and ticketing systems (emb |
...
| 4341 | TCP | lisp-data | LISP Data Packets |
| 4341 | UDP | lisp-data | LISP Data Packets |
| 4342 | TCP | lisp-cons | LISP-CONS Control |
...
| 4570 | TCP | deploymentmap | Service to distribute and update within a site deployment informa |
...
| 4840 | TCP | opcua-tcp | OPC UA TCP Protocol |
| 4840 | UDP | opcua-udp | OPC UA TCP Protocol |
...
| 5030 | TCP | surfpass | SurfPass |
| 5030 | UDP | surfpass | SurfPass |
...
| 5153 | TCP | toruxserver | ToruX Game Server |
...
| 5195 | TCP | ampl-lic | The protocol is used by a license server and client programs to c |
| 5196 | TCP | ampl-tableproxy | The protocol is used by two programs that exchange "table" data u |
...
| 5567 | TCP | enc-eps-mc-sec | EMIT protocol stack multicast/secure transport |
| 5567 | UDP | enc-eps-mc-sec | EMIT protocol stack multicast/secure transport |
| 5568 | TCP | sdt | Session Data Transport Multicast |
| 5568 | UDP | sdt | Session Data Transport Multicast |
| 5569 | TCP | rdmnet-ctrl | PLASA E1.33, Remote Device Management (RDM) controller status not |
...
| 5777 | TCP | dali-port | DALI Port |
| 5777 | UDP | dali-port | DALI Port |
...
| 5910 | TCP | cm | Context Management |
| 5910 | UDP | cm | Context Management |
| 5911 | SCTP | cpdlc | Controller Pilot Data Link Communication |
| 5911 | TCP | cpdlc | Controller Pilot Data Link Communication |
| 5911 | UDP | cpdlc | Controller Pilot Data Link Communication |
| 5912 | SCTP | fis | Flight Information Services |
| 5912 | TCP | fis | Flight Information Services |
| 5912 | UDP | fis | Flight Information Services |
| 5913 | SCTP | ads-c | Automatic Dependent Surveillance |
| 5913 | TCP | ads-c | Automatic Dependent Surveillance |
| 5913 | UDP | ads-c | Automatic Dependent Surveillance |
...
| 6201 | UDP | thermo-calc | Management of service nodes in a processing grid for thermodynami |
...
| 6511 | UDP | dccp-udp | Datagram Congestion Control Protocol Encapsulation for NAT Traver |
...
| 6716 | TCP | printercare-cc | PrinterCare cloud service |
...
| 6784 | UDP | bfd-lag | Bidirectional Forwarding Detection (BFD) on Link Aggregation Grou |
...
| 7547 | TCP | cwmp | DSL Forum CWMP |
| 7547 | UDP | cwmp | DSL Forum CWMP |
...
| 7680 | TCP | pando-pub | Pando Media Public Distribution |
| 7680 | UDP | pando-pub | Pando Media Public Distribution |
...
| 8276 | TCP | pando-sec | Pando Media Controlled Distribution |
...
| 8567 | TCP | enc-tunnel | EMIT tunneling protocol |
| 8567 | UDP | enc-tunnel | EMIT tunneling protocol |
...
| 8675 | TCP | msi-cps-rm | Motorola Solutions Customer Programming Software for Radio Manage |
| 8675 | UDP | msi-cps-rm-disc | Motorola Solutions Customer Programming Software for Radio Manage |
...
| 10631 | TCP | printopia | Port to allow for administration and control of "Printopia" appli |
...
| 11109 | TCP | sgi-dmfmgr | Data migration facility Manager (DMF) is a browser based interfac |
| 11110 | TCP | sgi-soap | Data migration facility (DMF) SOAP is a web server protocol to su |
...
| 11967 | UDP | sysinfo-sp | SysInfo Sercice Protocol |
...
| 12302 | TCP | rads | Remote Administration Daemon (RAD) is a system service that offer |
...
| 17221 | TCP | avdecc | IEEE 1722.1 AVB Discovery, Enumeration, Connection management, an |
| 17221 | UDP | avdecc | IEEE 1722.1 AVB Discovery, Enumeration, Connection management, an |
...
| 34980 | UDP | ethercat | EhterCAT Port |
...
| 44123 | TCP | z-wave-s | Z-Wave Secure Tunnel |
...
| 45000 | TCP | asmp | NSi AutoStore Status Monitoring Protocol data transfer |
| 45000 | UDP | asmp-mon | NSi AutoStore Status Monitoring Protocol device monitoring |
| 45001 | TCP | asmps | NSi AutoStore Status Monitoring Protocol secure data transfer |
...
| 46998 | TCP | spremotetablet | Connection between a desktop computer or server and a signature t |
...
> Total: 11380 assigned port/protocol entries
